...
img = cv.imread(r"C:/Users/ANA/Desktop/Webots - Erebus/rescate_laberinto/Alumnos/Alejandro_de_Ugarriza/TestVictimU.png")
...
#print(images["middle"].shape)
#print(images["bottom"].shape)
